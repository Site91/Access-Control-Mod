...
import com.cadergator10.advancedbasesecurity.common.interfaces.camo.CamoProperty;
...
import static com.cadergator10.advancedbasesecurity.common.blocks.BlockCardReader.PROPERTYFACING;

public class BlockCamo extends Block {
    public static final String CAMO = "camo";
    public static final CamoProperty CAMOID = new CamoProperty("camoid");

    public BlockCamo(Material blockMaterialIn) {
    ...
    public boolean shouldSideBeRendered(IBlockState state, IBlockAccess world, BlockPos pos, EnumFacing side) {
        ...
        if(block.getBlock() instanceof BlockCamo){
